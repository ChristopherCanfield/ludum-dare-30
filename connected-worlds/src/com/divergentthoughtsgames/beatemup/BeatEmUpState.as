package com.divergentthoughtsgames.beatemup {
	...
	public class BeatEmUpState extends FlxState
	{
		...
		// The players.
		private var player1: PlayerBeatEmUp;
		...
		private function setMapBoundaries(): void 
		{
			...
			floorTop = new FlxObject(0, floorBounds.top - (PlayerBeatEmUp.HEIGHT * PlayerBeatEmUp.MIN_SCALE_FACTOR), 
		...
		{
			var startX: int = 30;
			var startY: int = 545 - PlayerBeatEmUp.HEIGHT;
			player1 = new PlayerBeatEmUp(this, attackGroup, startX, startY, floorBounds, 1);
			players.add(player1);
			add(player1);
		}
		...
		private function onAttackHit(player: PlayerBeatEmUp, attack: AttackProjectile): void
		{
