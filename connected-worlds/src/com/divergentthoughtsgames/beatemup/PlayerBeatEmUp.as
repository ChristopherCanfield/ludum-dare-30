package com.divergentthoughtsgames.beatemup {
	 ...
	 */
	public class PlayerBeatEmUp extends FlxSprite
	{		
		...
		private var gameState: BeatEmUpState;
		...
		public function PlayerBeatEmUp(gameState: BeatEmUpState, attackGroup: FlxGroup, startX: int, startY: int,
